# Auto generated from calm.yaml by namespacegen.py version: 0.0.1
# Generation date: 2026-07-03T00:42:08
# Schema: calm
#
# id: https://w3id.org/lmodel/calm
# description: LinkML representation of the FINOS Common Architecture Language Model (CALM) 1.2 specification.
#              CALM is a declarative, JSON-based modeling language for describing complex software architectures
#              (nodes, relationships, controls, flows, decorators, timelines, evidence, and units). This LinkML
#              schema is generated from the CALM JSON-Schema meta files.
# license: Apache-2.0
...
class BiolinkNameSpace:
    ...
    _namespaces = [
        CurieNamespace('ai_governance_framework', 'https://w3id.org/lmodel/ai-governance-framework/'),
        CurieNamespace('attack', 'https://w3id.org/lmodel/attack/'),
        CurieNamespace('calm', 'https://w3id.org/lmodel/calm/'),
        ...
        CurieNamespace('dpv', 'https://w3id.org/lmodel/dpv/'),
        CurieNamespace('finos_calm', 'https://calm.finos.org/release/1.2/meta/'),
        CurieNamespace('fluxnova_bpmn_platform', 'https://w3id.org/lmodel/fluxnova-bpm-platform/'),
